...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-50 to-blue-100 p-6 flex items-center justify-center relative overflow-hidden">
      {/* Animated Background Elements */}
      <motion.div
        className="absolute top-20 left-20 w-32 h-32 bg-gradient-to-br from-pink-300/20 to-purple-300/20 rounded-full blur-xl"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.6, 0.3],
        }}
      ...
      />
      <motion.div
        className="absolute bottom-20 right-20 w-40 h-40 bg-gradient-to-br from-blue-300/20 to-cyan-300/20 rounded-full blur-xl"
        animate={{
          scale: [1, 1.3, 1],
          opacity: [0.2, 0.5, 0.2],
        }}
      ...
      />
      <motion.div
        className="absolute top-1/2 left-1/3 w-24 h-24 bg-gradient-to-br from-yellow-300/20 to-orange-300/20 rounded-full blur-xl"
        animate={{
          scale: [1, 1.4, 1],
          opacity: [0.4, 0.7, 0.4],
        }}
      ...
      <motion.div 
        ...
        className="w-full max-w-7xl bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden relative border border-white/30"
        style={{ height: "90vh" }}
      >
        <div className="flex h-full">
          {/* Left Side - Authentication Form */}
          <motion.div 
            className="w-full lg:w-2/5 flex items-center justify-center p-8 relative z-20"
                ...
                >
                  <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      >
                        ...
                        >
                          <Input
                            ...
                            className="h-12 border-2 border-gray-200/60 focus:border-blue-500 focus:ring-2 focus:ring-blue-100/50 rounded-xl transition-all duration-300 hover:border-gray-300 hover:shadow-sm focus:shadow-md bg-white/80 backdrop-blur-sm focus:bg-white"
                            required
                          />
                        </motion.div>
                      </motion.div>
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <Input
                          ...
                          className="h-12 pr-12 border-2 border-gray-200/60 focus:border-blue-500 focus:ring-2 focus:ring-blue-100/50 rounded-xl transition-all duration-300 hover:border-gray-300 hover:shadow-sm focus:shadow-md bg-white/80 backdrop-blur-sm focus:bg-white"
                          required
                        />
                        <motion.button
                          type="button"
                    ...
                    >
                      <Button
                        type="submit"
                        className="w-full h-12 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 rounded-xl relative overflow-hidden group"
                      >
                  ...
                  <div className="flex space-x-3">
                    ...
                    >
                      <Button
                        ...
                        variant="outline"
                        className="w-full h-12 border-2 border-gray-200/60 hover:border-blue-300 bg-white/80 backdrop-blur-sm hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-300 hover:shadow-md group relative overflow-hidden rounded-xl"
                      >
                    ...
                    >
                      <Button
                        variant="outline"
                        className="w-full h-12 border-2 border-gray-200/60 hover:border-blue-400 bg-white/80 backdrop-blur-sm hover:bg-blue-50 transition-all duration-300 hover:shadow-md rounded-xl"
                      >
                    ...
                    >
                      <Button
                        variant="outline"
                        className="w-full h-12 border-2 border-gray-200/60 hover:border-gray-400 bg-white/80 backdrop-blur-sm hover:bg-gray-50 transition-all duration-300 hover:shadow-md rounded-xl"
                      >
          ...
          >
            {/* Floating Elements */}
            <motion.div
              className="absolute top-16 left-16 w-20 h-20 bg-white/10 rounded-full"
              animate={{
                scale: [1, 1.2, 1],
                opacity: [0.3, 0.6, 0.3],
              }}
            ...
            />
            <motion.div
              className="absolute bottom-20 right-12 w-16 h-16 bg-white/20 rounded-full"
              animate={{
                scale: [1, 1.3, 1],
                opacity: [0.2, 0.5, 0.2],
              }}
            ...
            />
            <motion.div
              className="absolute top-1/3 right-24 w-12 h-12 bg-white/15 rounded-full"
              animate={{
                scale: [1, 1.4, 1],
                opacity: [0.4, 0.7, 0.4],
              }}
            ...
            >
              ...
              <div className="relative mx-auto mb-8">
                <motion.div 
                  className="w-80 h-80 mx-auto bg-gradient-to-br from-white/20 to-white/10 rounded-3xl flex items-center justify-center shadow-2xl relative overflow-hidden backdrop-blur-sm border border-white/20"
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col items-center">
                    ...
                    {/* Body/Device */}
                    <motion.div 
                      className="w-32 h-40 bg-gradient-to-br from-pink-200 to-purple-300 rounded-2xl relative shadow-lg"
                      animate={{ 
                        boxShadow: [
