...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-50 to-blue-100 py-4 px-4 flex items-center justify-center relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="w-full max-w-6xl bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden relative border border-white/30"
        style={{ height: "85vh", minHeight: "600px" }}
      >
        <div className="flex h-full">
          {/* Left Side - Authentication Form */}
          <motion.div 
            className="w-full lg:w-2/5 flex items-center justify-center p-6 relative z-20"
                        ...
                        >
                          ...
                          >
                            <Input
                              ...
                              className="h-11 border-2 border-gray-200/60 focus:border-blue-500 focus:ring-2 focus:ring-blue-100/50 rounded-xl transition-all duration-300 hover:border-gray-300 hover:shadow-sm focus:shadow-md bg-white/80 backdrop-blur-sm focus:bg-white input-neon-focus"
                              required
                            />
                          </motion.div>
                        </motion.div>
                      ...
                      <div className="space-y-2">
                        ...
                        >
                          <Input
                            ...
                            className="h-11 pr-12 border-2 border-gray-200/60 focus:border-blue-500 focus:ring-2 focus:ring-blue-100/50 rounded-xl transition-all duration-300 hover:border-gray-300 hover:shadow-sm focus:shadow-md bg-white/80 backdrop-blur-sm focus:bg-white input-neon-focus"
                            required
                          />
                          <motion.button
                            type="button"
