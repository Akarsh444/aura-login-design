...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-4 flex items-center justify-center">
      <div className="w-full max-w-6xl min-h-[85vh] bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden relative border border-white/20">
        <div className="flex h-full min-h-[85vh] flex-col md:flex-row">
                  ...
                  {activeTab === "signup" && (
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="h-14 border-2 border-gray-200/60 focus:border-blue-500 focus:ring-4 focus:ring-blue-100/50 rounded-xl transition-all duration-300 hover:border-gray-300 hover:shadow-md focus:shadow-lg bg-white/80 backdrop-blur-sm font-medium focus:bg-white group"
                        required
                      />
                    </div>
                  )}
          ...
          {/* Right Side - AI Assistant Illustration */}
          <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 items-center justify-center p-12 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
              ...
              <div className="absolute top-40 right-16 w-1 h-1 bg-indigo-400/40 rounded-full animate-pulse delay-1000"></div>
              <div className="absolute bottom-32 left-16 w-3 h-3 bg-purple-400/20 rounded-full animate-pulse delay-500"></div>
              <div className="absolute bottom-20 right-20 w-1.5 h-1.5 bg-blue-500/30 rounded-full animate-pulse delay-700"></div>
              <div className="absolute top-60 left-1/2 w-2 h-2 bg-indigo-300/30 rounded-full animate-pulse delay-300"></div>
            </div>

            {/* Main AI Assistant Illustration */}
            <div className="relative text-center max-w-lg transform hover:scale-105 transition-transform duration-500">
              {/* AI Assistant Visual */}
              <div className="mb-8 relative">
                <div className="w-64 h-64 mx-auto bg-gradient-to-br from-blue-100 to-indigo-200 rounded-3xl flex items-center justify-center shadow-2xl relative overflow-hidden animate-float">
                  {/* Glow Effect */}
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-200 to-indigo-300 rounded-3xl blur-lg opacity-40 animate-pulse scale-110"></div>
                  
                  {/* AI Robot Character */}
                  <div className="relative z-10 text-center">
                    {/* Robot Head */}
                    <div className="w-32 h-32 mx-auto mb-4 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl flex items-center justify-center shadow-lg relative">
                      {/* Eyes */}
                      <div className="flex space-x-3">
                        <div className="w-4 h-4 bg-white rounded-full animate-pulse flex items-center justify-center">
                          <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                        </div>
                        <div className="w-4 h-4 bg-white rounded-full animate-pulse delay-200 flex items-center justify-center">
                          <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                        </div>
                      </div>
                      {/* Signal Lines */}
                      <div className="absolute -top-2 left-1/2 transform -translate-x-1/2 flex space-x-1">
                        ...
                        <div className="w-1 h-4 bg-white/60 rounded-full animate-bounce delay-150"></div>
                        <div className="w-1 h-3 bg-white/80 rounded-full animate-bounce delay-300"></div>
                      </div>
                    </div>
              ...
              <div className="flex justify-center space-x-4">
                <div className="flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 shadow-lg border border-white/20 hover:scale-105 transition-transform duration-200">
                  <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
